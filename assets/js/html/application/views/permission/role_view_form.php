        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <!--   <a href="<?php echo base_url('Permission/add_module') ?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('module_list') ?> </a>
 -->
        ...
        <tbody>
                    ...
                    <?php if($this->permission1->method('role_list','update')->access()){?>                     
                                            <a href="<?php echo base_url().'Permission/edit_role/'.$row['id']; ?>" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                      <?php }?>
