		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								{accounts}
									<tr>
						                ...
						                <td>
						                    <center>
						                       <a href="<?php echo base_url().'Caccounts/inout_edit/{transection_id}/{table}/edit'; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('update') ?> "><i class="fa fa-pencil" aria-hidden="true"></i></a>
