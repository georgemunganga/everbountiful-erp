	    ...
	    <div class="row">
            <div class="col-sm-12">
                ...
                <?php if($this->permission1->method('add_bank','create')->access()){ ?>
                  <a href="<?php echo base_url('Csettings/index')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('add_new_bank')?> </a>
                  <?php }?>
									...
									<tr>
										...
										<?php echo form_open()?>
										 <?php if($this->permission1->method('bank_list','update')->access()){ ?>
											<a href="<?php echo base_url().'Csettings/edit_bank/{bank_id}'; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
										<?php }?>
										<?php echo form_close()?>
										</td>
									</tr>
