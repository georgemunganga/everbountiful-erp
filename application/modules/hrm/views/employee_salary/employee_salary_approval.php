                    ...
                    <table class="table table-bordered" id="request_table">
                        ...
                        <tbody id="payment_request_item">
                            <tr>
                                ...
                                <td>
                                    <a  id="add_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_payment_item('payment_request_item')"  tabindex="9"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                    ...
                    <table class="table table-bordered" id="tax_request_table">
                        ...
                        <tbody id="tax_payment_request_item">
                            <tr>
                                ...
                                <td>
                                    <a  id="add_tax_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_tax_payment_item('tax_payment_request_item')"  tabindex="9"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    function add_key_payment_item(e) {
        ...
        '<td> <a  id="add_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_payment_item('+"payment_request_item"+')"><i class="fa fa-plus-square" aria-hidden="true"></i></a> <a class="btn btn-danger btn-sm"  value="" onclick="deleteRow(this)" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
    ...
    function add_key_tax_payment_item(e) {
        ...
        '<td> <a  id="add_tax_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_tax_payment_item('+"tax_payment_request_item"+')"><i class="fa fa-plus-square" aria-hidden="true"></i></a> <a class="btn btn-danger btn-sm"  value="" onclick="deleteTaxPayRow(this)" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
    ...
    function add_key_npf_payment_item(e) {
        ...
        '<td> <a  id="add_npf_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_npf_payment_item('+"npf_payment_request_item"+')"><i class="fa fa-plus-square" aria-hidden="true"></i></a> <a class="btn btn-danger btn-sm"  value="" onclick="deleteNpfPayRow(this)" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
   ...
   /*IICF Contribution Js starts*/
    ...
    function add_key_iicf_payment_item(e) {
        ...
        '<td> <a  id="add_iicf_payment_item" class="btn btn-success btn-sm" name="add-invoice-item" onClick="add_key_iicf_payment_item('+"iicf_payment_request_item"+')"><i class="fa fa-plus-square" aria-hidden="true"></i></a> <a class="btn btn-danger btn-sm"  value="" onclick="deleteIicfPayRow(this)" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
