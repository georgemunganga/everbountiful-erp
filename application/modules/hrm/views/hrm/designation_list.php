        ...
        <div class="row">
         ...
         <?php if($this->permission1->method('manage_designation','update')->access()){ ?>                              
                                        <a href="<?php echo base_url() . 'designation_form/'.$designations['id']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php } ?>
