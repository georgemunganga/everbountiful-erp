        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="category_id" class="col-sm-4 col-form-label">Select suplier
                                <i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-sm-6" <?php if ($vattaxinfo->dynamic_tax != 1) {
                        ...
                        <div class="form-group row">
                            <label for="tax" class="col-sm-4 col-form-label"><?php echo $taxss['tax_name']; ?> <i
                                    class="text-danger"></i></label>
                            <div class="col-sm-7">
                                <input type="number" step="any" name="tax<?php echo $i; ?>" class="form-control" value="<?php $taxv = 'tax' . $i;
