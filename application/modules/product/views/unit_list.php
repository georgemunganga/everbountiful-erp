                                ...
                                <tbody>
                                  ...
                                  <td class="text-center"><?php if($categories->status ==1){echo display('active');}else{
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url().'unit_form/'.$categories->unit_id; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
