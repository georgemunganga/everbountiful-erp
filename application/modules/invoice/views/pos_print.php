    ...
    <div class="col-sm-5">
        <div class="panel panel-bd">
                    ...
                    <div class="invoice-wrap"
                            ...
                            <tbody>
                                ...
                                foreach ($invoice_all_data as $invoice_data) { ?>
                                    <tr>
                                        ...
                                        <th style="border: 1px solid #000;">
                                            <?php echo html_escape($invoice_data['batch_id']); ?>
                                        </th>
                                        <th style="border: 1px solid #000;">
                                            <?php echo html_escape($invoice_data['rate']); ?>
                                        </th>
                                        <th style="border: 1px solid #000;">
                                            <?php echo html_escape($invoice_data['discount']); ?>
                                        </th>
                                        ...
                                        <th style="border: 1px solid #000;">
                                            <?php echo html_escape($invoice_data['total_price']); ?>
                                        </th>
                                    </tr>
                                    <?php
                            ...
                            <tbody>
                                <tr>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                                        <?php echo display('tot_before_dis'); ?>
                                    </th>
                                    <th style="text-align: right;"><?php echo number_format($itemrow, 2, '.', ','); ?>
                                    </th>
                                </tr>
                                <tr>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                                        <?php echo display('discounts'); ?>
                                    </th>
                                    <th style="text-align: right;"><?php echo $all_discount ?></th>
                                </tr>
                                <tr>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                                        <?php echo display('tot_with_dis'); ?>
                                    </th>
                                    <th style="text-align: right;">
                                        <?php
                                        $itemrow = floatval($itemrow);
                                        $all_discount = floatval($all_discount);
                                        echo number_format($itemrow - $all_discount, 2, '.', ',');
                                        ?>
                                    </th>
                                </tr>
                                <?php if ($total_vat > 0) { ?>
                                    <tr>
                                        ...
                                        <th style="text-align: right;"><?php echo $total_vat ?></th>
                                ...
                                if ($total_tax > 0) { ?>
                                    <tr>
                                        <th style="text-align: right;padding: 3px 10px 3px 0px">
                                            <?php echo display('tax_vat'); ?>
                                        </th>
                                        <th style="text-align: right;"><?php echo $total_tax ?></th>
                                    </tr>
                                <?php } ?>
                                <tr>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                        ...
                        <div style="margin-bottom: 12px;">
                            <div
                                ...
                                <?php echo display('return_receipt_text'); ?>
                            </div>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <?= (!empty($create_at->CreateDate)) ? date("H:i:s", strtotime($create_at->CreateDate)) : '--:--:--'; ?>
                                    </th>
            ...
            <div class="panel-footer text-left">
                ...
                <a class="btn btn-success poolprint-btn" href="#" onclick="printDivnew('printableArea')"><span
