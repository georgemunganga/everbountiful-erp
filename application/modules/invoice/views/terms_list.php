                                ...
                                <tbody>
                                  ...
                                  <td class="text-center"><?php if($allterms->status ==1){echo display('active');}else{
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url().'terms_add/'.$allterms->id; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
