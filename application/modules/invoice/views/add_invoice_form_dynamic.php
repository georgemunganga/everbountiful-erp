            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <span class="padding-lefttitle">
                        ...
                        <a href="<?php echo base_url('invoice_list') ?>" class="btn btn-success m-b-5 m-r-2"><i
                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?php echo display('issue_location') ?: 'Issue Location'; ?></th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><a href="javascript:void(0)" id="add_invoice_item" class="btn btn-success"
