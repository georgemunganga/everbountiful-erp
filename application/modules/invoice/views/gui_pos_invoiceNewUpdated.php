                ...
                <div class="right_section">
                    ...
                    <div class="summary_section">
                        ...
                        <div class="vat_summary">
                            ...
                            <div class="item d-flex justify-content-between align-items-center gap-10">
                                <strong>Item</strong>
                                <div class="text-right"><strong>3</strong></div>
                            </div>
                            <!-- item-4 -->
            ...
            success: function (response) {
                ...
                if (response.length > 0) {
                    response.forEach(function (invoice) {
                        $dropdown.append(`<option value="${invoice.invoice_id}">${invoice.invoice_id}</option>`);
                    });
                } else {
...
<script>
    ...
    function update_total_payable() {
        ...
        console.log("Cash Amount:", cash_amount);
        console.log("Card Amount:", card_amount);
        console.log("Total Payable (Due):", due);
    }
    ...
    $('#draft_list').on('change', function () {
        ...
        `;
                    ...
                    $('#total_discount_ammount').val(parseFloat(invoice.total_discount || 0).toFixed(2));
                    ...
                    $('.vat_summary strong:contains("Item")').next().html('<strong>' + details.length + '</strong>');
                },
