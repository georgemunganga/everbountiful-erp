...
<div class="product-panel overflow-hidden border-0 shadow-sm bg-white" id="image-active_<?php echo $item->product_id ?>">
    ...
    <div class="panel-footer border-0 bg-white" onclick="onselectimage('<?php echo $item->product_id ?>')">
        ...
        <p class="text-center" style="color: #00A653; font-size: 12px; margin-top: 5px;">150 PC (S) in Stock</p>
    </div>
</div>
</div>
