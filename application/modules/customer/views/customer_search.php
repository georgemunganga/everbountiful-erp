 <?php if (!empty($customers)) {?>
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="<?php echo base_url("customer/customer/form/$value->customer_id") ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="pe-7s-note" aria-hidden="true"></i></a>  
