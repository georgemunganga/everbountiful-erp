       ...
       $this->db->select('acc_vaucher.id')
        ...
        foreach($records as $record ){
            ...
            if($this->permission1->method('aprove_v','update')->access()){
                ...
                $button .=' <a href="'.$base_url.'edit_voucher/'.$record->vid.'" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="'. display('update').'"><i class="fa fa-edit"></i></a> ';
