    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <span class="padding-lefttitle">
                        ...
                        <a href="<?php echo base_url("create_credit_voucher") ?>" class="btn btn-success btn-md"><i
            ...
            <div class="panel-body">
                <table width="100%" class="datatableReport table table-striped table-bordered table-hover"
                    cellspacing="0" width="100%" id="credittvList" title="creditVoucher">
                    <thead>
                        <tr>
...
<div class="modal fade " id="allvaucherModal" tabindex="-1" role="dialog" aria-labelledby="moduleModalLabel"
    aria-hidden="true">
