                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker"
                            value="<?php echo date("Y-m-d", strtotime('first day of January '.date('Y') )); ?>">
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="debtAccVoucher">
                        ...
                        <tbody id="debitvoucher">
                            <tr>
                                <td>
                                    <select name="cmbCode[]" required id="cmbCode_1" class="form-control"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="grandTotald" class="form-control text-right "
                                        name="grand_totald" value="" readonly="readonly" />
                                </td>
                                <td class="text-right">
                                    <input type="text" id="grandTotalc" class="form-control text-right "
                                        name="grand_totalc" value="" readonly="readonly" />
                                </td>
                            </tr>
                        </tfoot>
                    </table>
