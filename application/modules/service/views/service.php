<div class="row">
 ...
 <?php if($this->permission1->method('create_service','create')->access()){ ?>
                    <a href="<?php echo base_url('add_service') ?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_service') ?> </a>
<?php }?>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php } }?>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'edit_service/'.$services['service_id']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
