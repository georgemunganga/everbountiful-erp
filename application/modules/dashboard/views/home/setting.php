        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <img src="<?php echo $sdata->logo ? $sdata->logo : 'assets/img/icons/logo.png' ?>"
                            class="img img-responsive" height="100" width="100">
                        <input name="old_logo" type="hidden" value="<?php echo $sdata->logo ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="invoice_logo" class="col-sm-3 col-form-label"><?php echo display('invoice_logo') ?> <i
                            class="text-danger">*</i></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <img src="<?php echo $sdata->invoice_logo ? $sdata->invoice_logo : 'assets/img/icons/logo.png' ?>"
                            class="img img-responsive" height="100" width="100">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <img src="<?php echo $sdata->favicon ? $sdata->favicon : 'assets/img/icons/favicon.png' ?>"
                            class="img img-responsive" height="25" width="25">
                ...
                <div class="form-group row">
                    <label for="footer_text" class="col-sm-3 col-form-label"><?php echo display('footer_text') ?> <i
                            class="text-danger">*</i></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label for="discount_type" class="col-sm-3 col-form-label"><?php echo display('discount_type') ?> <i
                            class="text-danger">*</i></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label for="discount_type" class="col-sm-3 col-form-label"><?php echo display('invoice_qr_code') ?>
                        <i class="text-danger">*</i></label>
                    <div class="col-sm-6">
                        <input type="checkbox" name="is_qr" class="is-qr-pos" value="1"
                            <?php if ($sdata->is_qr == 1) {
                                echo 'checked';
                            } ?>>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="discount_type" class="col-sm-3 col-form-label"><?php echo display('is_autoapprove_v') ?>
                        <i class="text-danger">*</i></label>
                    <div class="col-sm-6">
                        <input type="checkbox" name="is_autoapprove_v" class="is-qr-pos" value="1"
                            <?php if ($sdata->is_autoapprove_v == 1) {
                                echo 'checked';
                            } ?>>
                    </div>
                </div>
