<div class="row">
    <div class="col-sm-12">
        ...
        <a href="<?php echo base_url('purchase_list')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <span class="print-button">
                        <button class="btn btn-success " onclick="printDivnew('printableArea')"><span
            ...
            <div class="panel-body " id="printableArea">
                ...
                <div class="row print-font-size purchasedetails-header">
                    ...
                    <table class="table table-striped print-font-size">
                        ...
                        <thead>
                            <tr>
                                <th width="5%" class="text-center"><?php echo display('sl') ?></th>
                                <th width="20%" class="text-center"><?php echo display('product_name') ?></th>
                                <th width="10%" class="text-center"><?php echo display('batch_no') ?></th>
                                ...
                                <th width="7%" class="text-right"><?php echo display('vat').' %' ?> </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center comp-web"><?php echo $details['batch_id']?></td>
