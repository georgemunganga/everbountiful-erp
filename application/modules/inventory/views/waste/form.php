    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(isset($form_action) ? $form_action : 'inventory/waste'); ?>
                    ...
                    <div class="form-group row">
                        <label for="waste_date" class="col-sm-3 col-form-label"><?php echo html_escape(display('date') ?: 'Date'); ?></label>
                        <div class="col-sm-6">
                            <input type="date" name="waste_date" id="waste_date" class="form-control" value="<?php echo html_escape(set_value('waste_date', date('Y-m-d'))); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <small class="form-text text-muted"><?php echo html_escape(display('override_warning') ?: 'Enable override only with supervisor approval.'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" class="btn btn-danger"><?php echo html_escape(display('record_waste') ?: 'Record Waste'); ?></button>
                        </div>
                    </div>
                <?php echo form_close(); ?>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-bd lobidrag">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4><?php echo html_escape(display('recent_waste') ?: 'Recent Waste'); ?></h4>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-striped">
                            ...
                            <tbody>
                                <?php foreach ($recent_waste as $row): ?>
                                    <tr>
